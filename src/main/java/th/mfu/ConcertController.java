...
public class ConcertController {
    ...
    private Map<Integer, Concert> IdToconcert = new HashMap<>();
    ...
    public String listConcerts(Model model) {
        ...
        List<Concert> concerts = new ArrayList<>(IdToconcert.values());
    ...
    public String saveConcert(@ModelAttribute Concert concert) {
        ...
        IdToconcert.put(concert.getId(), concert);
